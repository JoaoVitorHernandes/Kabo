...
/* select para produto */
$sqlProduto = "SELECT * FROM Produto_Tipo JOIN GPU ON fk_Cod_GPU = GPU.Cod_GPU WHERE Cod_Produto = $id";
...
$descricaoEspecificacoes = 'GPU ' . $rowProduto['Marca'] . ' ' . $rowProduto['Modelo'] . ' ' . $rowProduto['Tam_Memoria'] . 'GB ' . $rowProduto['Tipo_Mem'] . ' ' . $rowProduto['Nucleos'] . ' núcleos';
        ...
        <div class="boxfundo2">
            <div class="alignConteudo">
                ...
                <div class="alignTexts">
                    ...
                    <div class="alignInRow">
                        <p>Tamanho memória</p>
                        <p><?php echo $rowProduto['Tam_Memoria'];?>GB</p>
                    </div>
                    <div class="alignInRow">
                    ...
                    <div class="alignInRow">
                        <p>Conector</p>
                        <p><?php echo $rowProduto['Conector']; ?></p>
                    </div>
                </div>
