...
/* select para produto */
$sqlProduto = "SELECT * FROM Produto_Tipo JOIN Placa_mae ON fk_Cod_PlacaMae = Placa_mae.Cod_PlacaMae WHERE Cod_Produto = $id";
...
$descricaoEspecificacoes = 'Placa mãe ' . $rowProduto['Marca'] . ' ' . $rowProduto['Modelo'] . ' ' . $rowProduto['Soquete'] . ' ' . $rowProduto['Tipo_Mem'] . ' ' . $rowProduto['Vel_Mem'] . 'Mb/s';
        ...
        <div class="boxfundo2">
            <div class="alignConteudo">
                ...
                <div class="alignTexts">
                    ...
                    <div class="alignInRow">
                        <p>PCIe</p>
                        <p><?php echo $rowProduto['PCIe']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>M2</p>
                        <p><?php echo $rowProduto['M2']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>SATA</p>
                        <p><?php echo $rowProduto['SATA']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Tamanho</p>
                    ...
                    <div class="alignInRow">
                        <p>Chipset</p>
                        <p><?php echo $rowProduto['Chipset']; ?></p>
                    </div>
