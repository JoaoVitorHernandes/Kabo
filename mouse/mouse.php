...
/* select para produto */
$sqlProduto = "SELECT * FROM Produto_Tipo JOIN Mouse ON fk_Cod_Mouse = Mouse.Cod_Mouse WHERE Cod_Produto = $id";
...
$descricaoEspecificacoes = 'Mouse ' . $rowProduto['Marca'] . ' ' . $rowProduto['Modelo'] . ' ' . $rowProduto['Cor'] . ' ' . $rowProduto['DPI'] . 'DPI ' . $rowProduto['Tipo_Conexao'];
        ...
        <div class="boxfundo2">
            <div class="alignConteudo">
                ...
                <div class="alignTexts">
                    ...
                    <div class="alignInRow">
                        <p>DPI</p>
                        <p><?php echo $rowProduto['DPI']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Polling rate</p>
                        <p><?php echo $rowProduto['Polling_Rate']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Botões</p>
                        <p><?php echo $rowProduto['Botoes']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Cor</p>
