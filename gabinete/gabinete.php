...
/* select para produto */
$sqlProduto = "SELECT * FROM Produto_Tipo JOIN Gabinete ON fk_Cod_Gabinete = Gabinete.Cod_Gabinete WHERE Cod_Produto = $id";
...
$descricaoEspecificacoes = 'Gabinete ' . $rowProduto['Marca'] . ' ' . $rowProduto['Modelo'] . ' ' . $rowProduto['Slot_GPU'] . ' slots p/ GPU ' . $rowProduto['Tamanho_GPU'];
        ...
        <div class="boxfundo2">
            <div class="alignConteudo">
                ...
                <div class="alignTexts">
                    ...
                    <div class="alignInRow">
                        <p>Tamanho PM</p>
                        <p><?php echo $rowProduto['Tamanho_FT']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Tamanho FT</p>
                        <p><?php echo $rowProduto['Tamanho_FT']; ?></p>
                    ...
                    <div class="alignInRow">
                        <p>Tamanho GPU</p>
                        <p><?php echo $rowProduto['Tamanho_GPU']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Slots GPU</p>
                        <p><?php echo $rowProduto['Slot_GPU']; ?></p>
                    </div>
                </div>
