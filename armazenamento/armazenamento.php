...
/* select para produto */
$sqlProduto = "SELECT * FROM Produto_Tipo JOIN Armazenamento ON fk_Cod_Armazenamento = Armazenamento.Cod_Armazenamento WHERE Cod_Produto = $id";
...
$descricaoEspecificacoes = $rowProduto['Tipo'] . ' ' . $rowProduto['Conexao'] . ' ' . $rowProduto['Marca'] . ' ' . $rowProduto['Modelo'] . ' ' . $rowProduto['Capacidade'] . ' ' . $rowProduto['Velocidade'] . 'Mb/s';
        ...
        <div class="boxfundo2">
            <div class="alignConteudo">
                ...
                <div class="alignTexts">
                    ...
                    <div class="alignInRow">
                        <p>Tipo</p>
                        <p><?php echo $rowProduto['Tipo']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Capacidade</p>
                        <p><?php echo $rowProduto['Capacidade']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Velocidade</p>
                        <p><?php echo $rowProduto['Velocidade']; ?></p>
                    </div>
                    <div class="alignInRow">
                        <p>Conexão</p>
